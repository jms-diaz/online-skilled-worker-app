            ...
            <Row className="d-flex h-100">
                <Col className="pe-xxl-25 pe-md-7">
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Col className="mb-4">
                            <Form.Group>
                                ...
                                <select
                                    ...
                                    <option id='Administration & Office Support'>Administration & Office Support</option>
                                    <option id='Advertising, Arts & Media'>Advertising, Arts & Media</option>
                                    <option id='Banking & Financial Services'>Banking & Financial Services</option>
                                    <option id='Call Centre & Customer Service'>Call Centre & Customer Service</option>
                                    <option id='Community Services & Development'>Community Services & Development</option>
                                    ...
                                    <option id='Farming, Animals & Conservation'>Farming, Animals & Conservation</option>
                                    ...
                                    <option id='Human Resources & Recruitment'>Human Resources & Recruitment</option>
                                    <option id='Information & Communication Technology'>Information & Communication Technology</option>
                                    <option id='Insurance & Superannuation'>Insurance & Superannuation</option>
                                    <option id='Legal'>Legal</option>
                                    <option id='Manufacturing, Transport & Logistics'>Manufacturing, Transport & Logistics</option>
                        ...
                        <Col className="text-end">
                            <Button type="submit" className="fs-6 fw-bold btn py-2 px-7 mt-2 mb-4 text-end">Finish Resume</Button>
                        </Col>
                    </Form>
